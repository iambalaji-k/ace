# scripts/benchmark_all_agents.py
import sys
import time
import random
import numpy as np
...
class BenchmarkRLAgentV2(RLAgentV2):
    def __init__(self, player_id: int, seed=None):
        super().__init__(player_id, checkpoint_path="engine/rl_champion_v2.pt", explore=False, seed=seed)

class BenchmarkRLAgentV1(RLAgent):
    def __init__(self, player_id: int, seed=None):
        super().__init__(player_id, checkpoint_path="engine/rl_champion.pt", explore=False)
